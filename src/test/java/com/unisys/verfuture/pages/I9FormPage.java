 ...
 *
 */
public class I9FormPage extends TestBase {
	@FindBy(css = "[name='fullLegalName']")
	...
	@FindBy(css = "[name='exampleSelectMulti']")
	WebElement multiSelect;
	@FindBy(css = "[name='exampleFile']")
	WebElement fileUploadBtn;
	@FindBy(css = "[name='alienNumber']")
	...
	public I9FormPage(WebDriver driver) {
